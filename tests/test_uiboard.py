...
src.uiboard.ct = MagicMock(K_BOARD_SIZE=(None, 'key', None, 10), FIELD_BACKGROUND_COLOR='white', K_BOARD=('desc', 'key'), BOARD_LABEL_COLOR='black', BOARD_LABEL_FONT='Arial', CURSOR_LABEL_BACKGROUND_COLOR='gray')
