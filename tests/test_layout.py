...
src.layout.sg = MagicMock(
    ...
    Window=lambda *args, **kwargs: MagicMock(get_size=lambda: (10, 20), close=lambda: None, __getitem__=lambda self, k: MagicMock(get_size=lambda: (10, 20))),
...
def row_colors(): return 'row_colors'
def row_names(): return 'row_names'
def row_turn_indicators(): return 'row_turn_indicators'
def row_auto_moves(): return 'row_auto_moves'
def row_moves(): return 'row_moves'
def row_separator(label, bold): return 'row_separator'
def row_eval_show_num(): return 'row_eval_show_num'
def row_eval_hist(): return 'row_eval_hist'
def row_eval_moves(): return 'row_eval_moves'
def row_heatmap(): return 'row_heatmap'
def row_trials(): return 'row_trials'
def row_visits(): return 'row_visits'
def row_visualize_mcts(): return 'row_visualize_mcts'
def row_progress_bar(): return 'row_progress_bar'
def row_progress_nums(): return 'row_progress_nums'
