...
K_SMART_ROOT = ["smart root", "P1_SMART_ROOT", "P2_SMART_ROOT", False, False]
...
K_LEVEL = ["level", "P1_LEVEL", "P2_LEVEL", 1.0, 1.0]
...
K_HIGHLIGHT_LAST_MOVE = ["highlight last move", "HIGHLIGHT_LAST_MOVE", None, False]
...
K_TURN_INDICATOR = ["turn", "P1_TURN_INDICATOR", "P2_TURN_INDICATOR", TURN_CHAR, ""]
K_MOVES = ["moves", "MOVES"]
...
MSG_NO_CONFIG_FILE = (
    f"No settings file found.\nCreating {SETTINGS_FILE_NAME} with default settings."
)
